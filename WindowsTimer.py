...
def set_timer15(): start_logic(15)


def set_timer30(): start_logic(30)


def set_timer60(): start_logic(60)
...
tk.Label(root, text="Час (хвилини)", font=("Segoe UI", 11), bg=BG_COLOR, fg=TEXT).pack(pady=(15, 5))
...
for t in [15, 30, 60]:
    btn = tk.Button(button_frame, text=f"{t} хв",
                    ...
                    bg=BUTTON153060, fg="white", font=("Segoe UI", 8, "bold"),
...
btn_stop = tk.Button(root, text="Скасувати", command=cancel_timer,
                     bg=DANGER, fg="white", font=("Segoe UI", 10),
...
tk.Button(root, text="🇺🇦", command=privet, bg=BG_COLOR, fg="#FACC15",
          relief="flat", font=("Segoe UI", 12), cursor="hand2").pack(side="bottom", pady=5)
